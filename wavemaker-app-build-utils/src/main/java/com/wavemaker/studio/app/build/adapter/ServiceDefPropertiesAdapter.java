package com.wavemaker.studio.app.build.adapter;

import java.util.ArrayList;
import java.util.List;
import java.util.Map;

import com.wavemaker.studio.app.build.swaggerdoc.handler.ModelHandler;
import com.wavemaker.studio.app.build.swaggerdoc.handler.PropertyHandler;
